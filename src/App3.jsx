...
class App extends React.Component{
  ...
  constructor(props){
    super(props);
    this.state = {location: "Nigeria", isLoading: false, displayLocation:'', weather: {},};
  ...
  render(){
    return <div className="app">
      ...
      <div>
        <input type="text" placeholder="Search for a location..." value={this.state.location} onChange={(e) => this.setState({location: e.target.value})}  />
      </div>
    ...
    const {
      ...
      <div>
        ...
        <ul className="weather">
          {dates.map((date, i) => ( <Day date={date} max={max.at(i)}
          min={min.at(i)}
          code={codes.at(i)}
          key={date}
          isToday={i===0}
